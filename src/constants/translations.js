...
export const TRANSLATIONS = {
  "zh-tw": {
    ...
    delete_category_confirm: "確定要刪除分類「{{name}}」嗎？該分類下的詞庫將歸入「其他」。",
    edit_category: "編輯分類",
    ...
    image_url: "圖片連結",
    image_url_placeholder: "輸入圖片 URL 地址...",
    use_url: "使用連結",
    or: "或",
    upload_image: "上傳圖片",
    change_image: "更換圖片",
